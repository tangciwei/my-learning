    ...
    if (!a.jQuery) {
        ...
        c.isWindow = function (a) {
            ...
            c.each(a.nodeType ? [a] : a, function (a, d) {
                ...
                var a = a.apply(b);
                var d = this.offset();
                var e = /^(?:body|html)$/i.test(a.nodeName) ? {top: 0, left: 0} : c(a).offset();
...
var z = function (b) {
                            ...
                            if (g(y)) {
                                ...
                                for (var B in w) {
                                    if ('element' !== B) {
                                        var C;
                                        var D = w[B];
                                        var E = p.isString(D.easing) ? t.Easings[D.easing] : D.easing;
                                        if (1 === r) {
                                            C = D.endValue;
                                        }
                                        else {
        ...
        var u = function () {
            ...
            function c(c, d) {
                ...
                var g = b(c, .5 * d, f);
                var h = b(c, d, g);
                var i = 1 / 6 * (e.dx + 2 * (f.dx + g.dx) + h.dx);
                var j = 1 / 6 * (e.dv + 2 * (f.dv + g.dv) + h.dv);
        ...
        var v = t.CSS = {
                ...
                register: function () {
                    ...
                    if (n) {
                        for (c in v.Hooks.templates) {
                            d = v.Hooks.templates[c], e = d[0].split(' ');var f = d[1].match(v.RegEx.valueSplit);
            ...
            Normalizations: {registered: {clip: function (a, b, c) {
                        switch (a) {
                            case 'name':
                                ...
                                var d;
                                return v.RegEx.wrappedValueAlreadyExtracted.test(c) ? d = c : (d = c.toString().match(v.RegEx.valueUnwrap), d = d ? d[1].replace(/,(\s+)?/g, ' ') : c), d;case 'inject':
                                return 'rect(' + c + ')';
                        }
                    }, blur: function (a, b, c) {
                        switch (a) {
                        ...
                        if (8 >= n) {
                            switch (a) {
                                case 'name':
                                    ...
                                    return c = d ? d[1] / 100 : 1;case 'inject':
            ...
            Values: {
                hexToRgb: function (a) {
                    ...
                    var d = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i;
            ...
            flushTransformCache: function (a) {
                ...
                if ((n || t.State.isAndroid && !t.State.isChrome) && g(a).isSVG) {
                    ...
                    m.each(g(a).transformCache, function (a) {
                        /^translate/i.test(a) ? a = 'translate' : /^scale/i.test(a) ? a = 'scale' : /^rotate/i.test(a) && (a = 'rotate'), d[a] && (c += a + '(' + d[a].join(' ') + ') ',
                        delete d[a]
                        );
                    });
                }
            ...
            function e() {
                function a(a) {
                    ...
                    function r() {
                        ...
                        var d = a.position === I.lastPosition && a.myParent === I.lastParent;
                        var e = a.fontSize === I.lastFontSize;
...
var i = {};
                    ...
                    if ('scroll' === C) {
                        ...
                        }, element: f}, t.debug && console.log('tweensContainer (scroll): ', i.scroll, f);
                    }
                    else if ('reverse' === C) {
                        ...
                        'none' === g(f).opts.display && (g(f).opts.display = 'auto'), 'hidden' === g(f).opts.visibility && (g(f).opts.visibility = 'visible'), g(f).opts.loop = !1, g(f).opts.begin = null, g(f).opts.complete = null, s.easing ||
                        delete h.easing
                        , s.duration ||
                        delete h.duration
                        ...
                        for (var K in q) {
                            ...
                            var N = L[1];
                            var O = L[2];
                            K = v.Names.camelCase(K);var P = v.Hooks.getRoot(K);
var Q = !1;
            ...
            var q;
            var s;
            var u = arguments[0] && (arguments[0].p || m.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || p.isString(arguments[0].properties));
            if (p.isWrapped(this) ? (h = !1, n = 0, o = this, i = this) : (h = !0, n = 1, o = u ? arguments[0].elements || arguments[0].e : arguments[0]), o = f(o)) {
                ...
                if (E.loop = parseInt(E.loop, 10), K = 2 * E.loop - 1, E.loop) {
                    for (var L = 0; K > L; L++) {
        ...
        return t.State.isMobile || c.hidden === d || c.addEventListener('visibilitychange', function () {
                ...
                t.Redirects['slide' + b] = function (a, c, e, f, g, h) {
                    ...
                    var j = i.begin;
                    var k = i.complete;
                    var l = {height: '', marginTop: '', marginBottom: '', paddingTop: '', paddingBottom: ''};
                    var n = {};
                    i.display === d && (i.display = 'Down' === b ? 'inline' === t.CSS.Values.getDisplayType(a) ? 'inline-block' : 'block' : 'none'), i.begin = function () {
                        j && j.call(g, g);
                        for (var c in l) {
                            n[c] = a.style[c];var d = t.CSS.getPropertyValue(a, c);
                            l[c] = 'Down' === b ? [d, 0] : [0, d];
                        }
...
var i = b.center = F(d);
    ...
    function F(a) {
        var b = a.length;
        if (1 === b) {
            return {x: la(a[0].clientX), y: la(a[0].clientY)};
        }
...
var e = b[c[1]] - a[c[1]];
    ...
    function R(a, b) {
        ...
        for (e = 0; e < g.length;) {
            d[g[e].identifier] && h.push(g[e]), b & (Aa | Ba) &&
            delete d[g[e].identifier]
            , e++;
    ...
    function S() {
        y.apply(this, arguments);var a = k(this.handler, this);
    ...
    var ja = b.createElement('div');
    var ka = 'function';
    var la = Math.round;
    var ma = Math.abs;
    var na = Date.now;
    var oa = 1;
    var pa = /mobile|tablet|ip(ad|hone|od)|android/i;
    var qa = 'ontouchstart' in a;
    var ra = v(a, 'PointerEvent') !== d;
    var sa = qa && pa.test(navigator.userAgent);
    var ta = 'touch';
    var ua = 'pen';
    var va = 'mouse';
    var wa = 'kinect';
    ...
    var Qa = {2: ta, 3: ua, 4: va, 5: wa};
    var Ra = 'pointerdown';
    var Sa = 'pointermove pointerup pointercancel';
    a.MSPointerEvent && (Ra = 'MSPointerDown', Sa = 'MSPointerMove MSPointerUp MSPointerCancel'), j(N, y, {
        handler: function (a) {
            ...
            var e = Pa[d];
            var f = Qa[a.pointerType] || a.pointerType;
            var g = f == ta;
    ...
    var Xa = 'touchstart touchmove touchend touchcancel';
    j(Q, y, {
        handler: function (a) {
            var b = Wa[a.type];
    ...
    V.prototype = {
    ...
    }}), j($, Z, {defaults: {event: 'pan', threshold: 10, pointers: 1, direction: Ja}, getTouchAction: function () {
    ...
    }}), j(aa, V, {defaults: {event: 'press', pointers: 1, time: 500, threshold: 5}, getTouchAction: function () {
            return [_a];
        }, process: function (a) {
            var b = this.options;
    ...
    }}), j(ba, Z, {defaults: {event: 'rotate', threshold: 0, pointers: 2}, getTouchAction: function () {
            return [bb];
        }, attrTest: function (a) {
            return this._super.attrTest.call(this, a) && (Math.abs(a.rotation) > this.options.threshold || this.state & fb);
    }}), j(ca, Z, {defaults: {event: 'swipe', threshold: 10, velocity: .65, direction: Ha | Ia, pointers: 1}, getTouchAction: function () {
        ...
        process: function (a) {
            ...
            if (d && f && c) {
                ...
                var h = !this.pCenter || I(this.pCenter, a.center) < b.posThreshold;
        ...
        preset: [[ba, {
            ...
            direction: Ha
        }, ['swipe']], [da], [da, {event: 'doubletap', taps: 2}, ['tap']], [aa]],
        cssProps: {
            userSelect: 'default',
            touchSelect: 'none',
            touchCallout: 'none',
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function (a) {
    a.fn.collapsible = function (b, c) {
        ...
        return b = a.extend(d, b), this.each(function () {
                function d(b) {
                    l = k.find('> li > .collapsible-header'), b.hasClass('active') ? b.parent().addClass('active') : b.parent().removeClass('active'), b.parent().hasClass('active') ? b.siblings('.collapsible-body').stop(!0, !1).slideDown({duration: 350, easing: 'easeOutQuart', queue: !1, complete: function () {
                            a(this).css('height', '');
                    }}) : b.siblings('.collapsible-body').stop(!0, !1).slideUp({duration: 350, easing: 'easeOutQuart', queue: !1, complete: function () {
                            a(this).css('height', '');
                    }}), l.not(b).removeClass('active').parent().removeClass('active'), l.not(b).parent().children('.collapsible-body').stop(!0, !1).each(function () {
                        a(this).is(':visible') && a(this).slideUp({duration: 350, easing: 'easeOutQuart', queue: !1, complete: function () {
                                a(this).css('height', ''), h(a(this).siblings('.collapsible-header'));
                        }});
                    });
                }
                function f(b) {
                    b.hasClass('active') ? b.parent().addClass('active') : b.parent().removeClass('active'), b.parent().hasClass('active') ? b.siblings('.collapsible-body').stop(!0, !1).slideDown({duration: 350, easing: 'easeOutQuart', queue: !1, complete: function () {
                            a(this).css('height', '');
                    }}) : b.siblings('.collapsible-body').stop(!0, !1).slideUp({duration: 350, easing: 'easeOutQuart', queue: !1, complete: function () {
                            a(this).css('height', '');
                    }});
                ...
                function g(a) {
                    a.toggleClass('active'), b.accordion || 'accordion' === m || void 0 === m ? d(a) : f(a), h(a);
                }
                function h(a) {
                ...
                var k = a(this);
                var l = a(this).find('> li > .collapsible-header');
                var m = k.data('collapsible');
                if (c >= 0 && c < l.length) {
                    var n = l.eq(c);
                    return void (n.length && ('open' === e || 'close' === e && n.hasClass('active')) && g(n));
                }

                k.off('click.collapse', '> li > .collapsible-header'), l.off('click.collapse'), k.on('click.collapse', '> li > .collapsible-header', function (b) {
                    var c = a(b.target);
                    i(c) && (c = j(c)), g(c);
                }), b.accordion || 'accordion' === m || void 0 === m ? g(l.filter('.active').first()) : l.filter('.active').each(function () {
                    g(a(this));
                });
            });
...
var e = g.innerHeight();
var k = g.offset().left;
var l = g.offset().top - a(window).scrollTop();
var m = h.alignment;
var n = 0;
var o = 0;
var p = 0;
                h.belowOrigin === !0 && (p = e);var q = 0;
var r = 0;
var s = g.parent();
                if (s.is('body') || (s[0].scrollHeight > s[0].clientHeight && (q = s[0].scrollTop), s[0].scrollWidth > s[0].clientWidth && (r = s[0].scrollLeft)), k + j.innerWidth() > a(window).width() ? m = 'right' : k - j.innerWidth() + g.innerWidth() < 0 && (m = 'left'), l + j.innerHeight() > c) {
                    if (l + e - j.innerHeight() < 0) {
                        ...
                        p || (p += e), p -= j.innerHeight();
                    }

                }
                if ('left' === m) {
                    n = h.gutter, o = g.position().left + n;
                }
                else if ('right' === m) {
                ...
                j.css({position: 'absolute', top: g.position().top + p + q, left: o + r}), j.stop(!0, !0).css('opacity', 0).slideDown({queue: !1, duration: h.inDuration, easing: 'easeOutCubic', complete: function () {
                        a(this).css('height', '');
                }}).animate({
                    opacity: 1
                }, {queue: !1, duration: h.inDuration, easing: 'easeOutSine'}), a(document).bind('click.' + j.attr('id') + ' touchstart.' + j.attr('id'), function (b) {
                    j.is(b.target) || g.is(b.target) || j.find(b.target).length || (f(), a(document).unbind('click.' + j.attr('id') + ' touchstart.' + j.attr('id')));
                });
            }
            function f() {
                i = !1, j.fadeOut(h.outDuration), j.removeClass('active'), g.removeClass('active'), a(document).unbind('click.' + j.attr('id') + ' touchstart.' + j.attr('id')), setTimeout(function () {
                    j.css('max-height', '');
                }, h.outDuration);
            }
            var g = a(this);
            ...
            if (d(), g.after(j), h.hover) {
                ...
                g.unbind('click.' + g.attr('id')), g.bind('click.' + g.attr('id'), function (b) {
                    i || (g[0] != b.currentTarget || g.hasClass('active') || 0 !== a(b.target).closest('.dropdown-content').length ? g.hasClass('active') && (f(), a(document).unbind('click.' + j.attr('id') + ' touchstart.' + j.attr('id'))) : (b.preventDefault(), h.stopPropagation && b.stopPropagation(), e('click')));
                });
            }
    ...
    var e = {init: function (c) {
                ...
                return c = a.extend(e, c), this.each(function () {
                        var e = a(this);
                        var f = a(this).attr('id') || '#' + a(this).data('target');
                        var g = function () {
                                var d = e.data('overlay-id');
                                var f = a('#' + d);
                                e.removeClass('open'), a('body').css({overflow: '', width: ''}), e.find('.modal-close').off('click.close'), a(document).off('keyup.modal' + d), f.velocity({
                                    opacity: 0
                                }, {duration: c.outDuration, queue: !1, ease: 'easeOutQuart'});
                                var g = {duration: c.outDuration, queue: !1, ease: 'easeOutCubic', complete: function () {
                                        a(this).css({
                                            display: 'none'
                        ...
                        var h = function (f) {
                                ...
                                if (h.css('overflow', 'hidden'), h.width(i), !e.hasClass('open')) {
                                    var j = d();
                                    var k = a('<div class="modal-overlay"></div>');
                                    lStack = ++b, k.attr('id', j).css('z-index', 1e3 + 2 * lStack), e.data('overlay-id', j).css('z-index', 1e3 + 2 * lStack + 1), e.addClass('open'), a('body').append(k), c.dismissible && (k.click(function () {
                                        ...
                                        g();
                                    }), k.css({display: 'block', opacity: 0}), e.css({display: 'block', opacity: 0}), k.velocity({
                                        opacity: c.opacity
                                    }, {duration: c.inDuration, queue: !1, ease: 'easeOutCubic'}), e.data('associated-overlay', k[0]);
                                    var l = {duration: c.inDuration, queue: !1, ease: 'easeOutCubic', complete: function () {
                                            'function' == typeof c.ready && c.ready.call(this, e, f);
                                    }};
                                    e.hasClass('bottom-sheet') ? e.velocity({bottom: '0', opacity: 1}, l) : (a.Velocity.hook(e, 'scaleX', .7), e.css({
                                        top: c.startingTop
                                    }), e.velocity({top: c.endingTop, opacity: 1, scaleX: '1'}, l));
                                }
...
var d = (window.innerWidth, window.innerHeight, i.data('width'));
var g = i.data('height');
                i.velocity('stop', !0), a('#materialbox-overlay').velocity('stop', !0), a('.materialbox-caption').velocity('stop', !0), a('#materialbox-overlay').velocity({
                    opacity: 0
                }, {duration: h, queue: !1, easing: 'easeOutQuad', complete: function () {
                        e = !1, a(this).remove();
                }}), i.velocity({width: d, height: g, left: 0, top: 0}, {duration: h, queue: !1, easing: 'easeOutQuad', complete: function () {
            ...
            if (!a(this).hasClass('initialized')) {
                ...
                i.wrap(j), i.on('click', function () {
                    ...
                    if (o.css({width: j, height: k, left: -1 * p.left, top: -1 * p.top}), o.velocity({
                            opacity: 1
                        }, {duration: g, queue: !1, easing: 'easeOutQuad'}), '' !== i.data('caption')) {
                        var q = a('<div class="materialbox-caption"></div>');
                        q.text(i.data('caption')), a('body').append(q), q.css({
                            display: 'inline'
                        }), q.velocity({
                            opacity: 1
                        }, {duration: g, queue: !1, easing: 'easeOutQuad'});
                    }
                    ...
                    var u = 0;
                    var v = 0;
                    s > t ? (r = m / l, u = .9 * j, v = .9 * j * r) : (r = l / m, u = .9 * k * r, v = .9 * k), i.hasClass('responsive-img') ? i.velocity({'max-width': u, 'width': l}, {duration: 0, queue: !1, complete: function () {
                            i.css({left: 0, top: 0}).velocity({height: v, width: u, left: a(document).scrollLeft() + j / 2 - i.parent('.material-placeholder').offset().left - u / 2, top: a(document).scrollTop() + k / 2 - i.parent('.material-placeholder').offset().top - v / 2}, {duration: g, queue: !1, easing: 'easeOutQuad', complete: function () {
                                    f = !0;
                            }});
                    }}) : i.css('left', 0).css('top', 0).velocity({height: v, width: u, left: a(document).scrollLeft() + j / 2 - i.parent('.material-placeholder').offset().left - u / 2, top: a(document).scrollTop() + k / 2 - i.parent('.material-placeholder').offset().top - v / 2}, {duration: g, queue: !1, easing: 'easeOutQuad', complete: function () {
                            f = !0;
                    }});
    ...
    a.fn.parallax = function () {
        ...
        return this.each(function (c) {
            function d(c) {
                var d;
                d = b < 601 ? e.height() > 0 ? e.height() : e.children('img').height() : e.height() > 0 ? e.height() : 500;var f = e.children('img').first();
var g = f.height();
var h = g - d;
var i = e.offset().top + d;
var j = e.offset().top;
var k = a(window).scrollTop();
var l = window.innerHeight;
var m = k + l;
var n = (m - j) / (d + l);
var o = Math.round(h * n);
    ...
    var b = {init: function (b) {
            ...
            return b = a.extend(c, b), this.each(function () {
                    ...
                    var j = h.find('li.tab a');
                    var k = h.width();
                    var l = a();
                    var m = Math.max(k, h[0].scrollWidth) / j.length;
                    var n = prev_index = 0;
                    var o = !1;
                    var p = 300;
                    var q = function (a) {
                    ...
                    var s = function (a) {
                            n - a >= 0 ? (f.velocity({
                                right: q(c)
                            }, {duration: p, queue: !1, easing: 'easeOutQuad'}), f.velocity({
                                left: r(c)
                            }, {duration: p, queue: !1, easing: 'easeOutQuad', delay: 90})) : (f.velocity({
                                left: r(c)
                            }, {duration: p, queue: !1, easing: 'easeOutQuad'}), f.velocity({
                                right: q(c)
                            }, {duration: p, queue: !1, easing: 'easeOutQuad', delay: 90}));
                        };
                    b.swipeable && i > b.responsiveThreshold && (b.swipeable = !1), c = a(j.filter('[href="' + location.hash + '"]')), 0 === c.length && (c = a(this).find('li.tab a.active').first()), 0 === c.length && (c = a(this).find('li.tab a').first()), c.addClass('active'), n = j.index(c), n < 0 && (n = 0), void 0 !== c[0] && (d = a(c[0].hash), d.addClass('active')), h.find('.indicator').length || h.append('<div class="indicator"></div>'), f = h.find('.indicator'), h.append(f), h.is(':visible') && setTimeout(function () {
                        f.css({
                            right: q(c)
                        }), f.css({
                            left: r(c)
                        });
                    }, 0), a(window).off('resize.tabs').on('resize.tabs', function () {
                        k = h.width(), m = Math.max(k, h[0].scrollWidth) / j.length, n < 0 && (n = 0), 0 !== m && 0 !== k && (f.css({
                            right: q(c)
                        }), f.css({
                            left: r(c)
                        }));
                    }), b.swipeable ? (j.each(function () {
                        var b = a(Materialize.escapeHash(this.hash));
                        b.addClass('carousel-item'), l = l.add(b);
                    }), e = l.wrapAll('<div class="tabs-content carousel"></div>'), l.css('display', ''), a('.tabs-content.carousel').carousel({fullWidth: !0, noWrap: !0, onCycleTo: function (a) {
                            if (!o) {
                                var b = n;
                                n = e.index(a), c = j.eq(n), s(b);
                            }

                    }})) : j.not(c).each(function () {
                        a(Materialize.escapeHash(this.hash)).hide();
                    }), h.off('click.tabs').on('click.tabs', 'a', function (e) {
                        if (a(this).parent().hasClass('disabled')) {
                            return void e.preventDefault();
                        }

                        if (!a(this).attr('target')) {
                            o = !0, k = h.width(), m = Math.max(k, h[0].scrollWidth) / j.length, c.removeClass('active');
                            var f = d;
                            c = a(this), d = a(Materialize.escapeHash(this.hash)), j = h.find('li.tab a');c.position();c.addClass('active'), prev_index = n, n = j.index(a(this)), n < 0 && (n = 0), b.swipeable ? l.length && l.carousel('set', n) : (void 0 !== d && (d.show(), d.addClass('active'), 'function' == typeof b.onShow && b.onShow.call(this, d)), void 0 === f || f.is(d) || (f.hide(), f.removeClass('active'))), g = setTimeout(function () {
                                o = !1;
                            }, p), s(prev_index), e.preventDefault();
                        }
    ...
    a.fn.tooltip = function (c) {
        var d = 5;
        var e = {delay: 350, tooltip: '', position: 'bottom', html: !1};
        return 'remove' === c ? (this.each(function () {
            ...
            f.on({'mouseenter.tooltip': function (a) {
                    var c = function () {
                        m(), p = !0, k.velocity('stop'), l.velocity('stop'), k.css({visibility: 'visible', left: '0px', top: '0px'});
                        var a;
                        var c;
                        var e;
                        var g = f.outerWidth();
                        ...
                        var o = '0px';
                        var q = '0px';
                        var r = l[0].offsetWidth;
                        var s = l[0].offsetHeight;
                        var t = 8;
                        var u = 8;
                        var v = 0;
                        'top' === i ? (a = f.offset().top - j - d, c = f.offset().left + g / 2 - n / 2, e = b(c, a, n, j), o = '-10px', l.css({
                            ...
                            marginTop: j / 2,
                            marginLeft: '0px'
                        })) : (a = f.offset().top + f.outerHeight() + d, c = f.offset().left + g / 2 - n / 2, e = b(c, a, n, j), o = '+10px', l.css({top: 0, left: 0, marginLeft: n / 2 - r / 2})), k.css({top: e.y, left: e.x}), t = Math.SQRT2 * n / parseInt(r, 10), u = Math.SQRT2 * j / parseInt(s, 10), v = Math.max(t, u), k.velocity({translateY: o, translateX: q}, {duration: 350, queue: !1}).velocity({
                            opacity: 1
                        }, {duration: 300, delay: 50, queue: !1}), l.css({
                            visibility: 'visible'
                        }).velocity({
                            opacity: 1
                        }, {duration: 55, delay: 0, queue: !1}).velocity({scaleX: v, scaleY: v}, {duration: 300, delay: 0, queue: !1, easing: 'easeInOutQuad'});
                    };
                    o = setTimeout(c, h);
                }, 'mouseleave.tooltip': function () {
                    p = !1, clearTimeout(o), setTimeout(function () {
                        p !== !0 && (k.velocity({opacity: 0, translateY: 0, translateX: 0}, {duration: 225, queue: !1}), l.velocity({opacity: 0, scaleX: 1, scaleY: 1}, {duration: 225, queue: !1, complete: function () {
                                l.css({
                                    visibility: 'hidden'
                                }), k.css({
                                    visibility: 'hidden'
    ...
    var j = {duration: 750, show: function (a, b) {
                if (2 === a.button) {
                    return !1;
                }
                ...
                var g = d(c);
                var h = a.pageY - g.top;
                var i = a.pageX - g.left;
                var k = 'scale(' + c.clientWidth / 100 * 10 + ')';
                ...
                k.touchup(a);
                var b = this;
                var c = (1.4 * b.clientWidth, null);
                var d = b.getElementsByClassName('waves-ripple');
                if (!(d.length > 0)) {
                    return !1;
                }
                ...
                var g = c.getAttribute('data-y');
                var h = c.getAttribute('data-scale');
                var i = Date.now() - Number(c.getAttribute('data-hold'));
                var l = 350 - i;
    ...
    var k = {touches: 0, allowEvent: function (a) {
                var b = !0;
    ...
    function e(a) {
        ...
        ('object' == typeof HTMLElement ? a instanceof HTMLElement : a && 'object' == typeof a && null !== a && 1 === a.nodeType && 'string' == typeof a.nodeName) ? b.appendChild(a) : a instanceof jQuery ? b.appendChild(a[0]) : b.innerHTML = a;var h = new Hammer(b, {
            prevent_default: !1
        });
        return h.on('pan', function (a) {
                ...
                e < 0 && (e = 0), Vel(b, {left: c, opacity: e}, {duration: 50, queue: !1, easing: 'easeOutQuad'});
    ...
    null != i && (h = setInterval(function () {
        null === g.parentNode && window.clearInterval(h), g.classList.contains('panning') || (i -= 20), i <= 0 && (Vel(g, {opacity: 0, marginTop: '-40px'}, {duration: 375, easing: 'easeOutExpo', queue: !1, complete: function () {
    ...
    var b = {init: function (b) {
            ...
            b = a.extend(c, b), a(this).each(function () {
                ...
                b.draggable && (f.on('click', function () {
                    ...
                    if ('touch' == c.gesture.pointerType) {
                        ...
                        var f = (c.gesture.center.y, c.gesture.velocityX, a('body'));
                        var h = a('#sidenav-overlay');
                        var j = f.innerWidth();
                        if (f.css('overflow', 'hidden'), f.width(j), 0 === h.length && (h = a('<div id="sidenav-overlay"></div>'), h.css('opacity', 0).click(function () {
                                g();
                            }), a('body').append(h)), 'left' === b.edge && (d > b.menuWidth ? d = b.menuWidth : d < 0 && (d = 0)), 'left' === b.edge) {
                            d < b.menuWidth / 2 ? i = !1 : d >= b.menuWidth / 2 && (i = !0), e.css('transform', 'translateX(' + (d - b.menuWidth) + 'px)');
                        }
                        else {
                        ...
                        'left' === b.edge ? (l = d / b.menuWidth, h.velocity({
                            opacity: l
                        }, {duration: 10, queue: !1, easing: 'easeOutQuad'})) : (l = Math.abs((d - window.innerWidth) / b.menuWidth), h.velocity({
                            opacity: l
                    ...
                    if ('touch' == c.gesture.pointerType) {
                        ...
                        var g = c.gesture.velocityX;
                        var j = c.gesture.center.x;
                        var k = j - b.menuWidth;
                        var l = j - b.menuWidth / 2;
                        k > 0 && (k = 0), l < 0 && (l = 0), h = !1, 'left' === b.edge ? i && g <= .3 || g < -.5 ? (0 !== k && e.velocity({
                            translateX: [0, k]
                        }, {duration: 300, queue: !1, easing: 'easeOutQuad'}), d.velocity({
                            opacity: 1
                        }, {duration: 50, queue: !1, easing: 'easeOutQuad'}), f.css({width: '50%', right: 0, left: ''}), i = !0) : (!i || g > .3) && (a('body').css({overflow: '', width: ''}), e.velocity({
                            translateX: [-1 * b.menuWidth - 10, k]
                        }, {duration: 200, queue: !1, easing: 'easeOutQuad'}), d.velocity({
                            opacity: 0
                        }, {duration: 200, queue: !1, easing: 'easeOutQuad', complete: function () {
                                a(this).remove();
                        }}), f.css({width: '10px', right: '', left: 0})) : i && g >= -.3 || g > .5 ? (0 !== l && e.velocity({
                            translateX: [0, l]
                        }, {duration: 300, queue: !1, easing: 'easeOutQuad'}), d.velocity({
                            opacity: 1
                        }, {duration: 50, queue: !1, easing: 'easeOutQuad'}), f.css({width: '50%', right: '', left: 0}), i = !0) : (!i || g < -.3) && (a('body').css({overflow: '', width: ''}), e.velocity({
                    ...
                    if (i === !0) {
                        ...
                        var j = c.innerWidth();
                        c.css('overflow', 'hidden'), c.width(j), a('body').append(f), 'left' === b.edge ? (f.css({width: '50%', right: 0, left: ''}), e.velocity({
                            translateX: [0, -1 * b.menuWidth]
                        }, {duration: 300, queue: !1, easing: 'easeOutQuad'})) : (f.css({width: '50%', right: '', left: 0}), e.velocity({
                            translateX: [0, b.menuWidth]
                        }, {duration: 300, queue: !1, easing: 'easeOutQuad'})), d.css('opacity', 0).click(function () {
            ...
            var c = a('.drag-target[data-sidenav="' + a(this).attr('data-activates') + '"]');
...
var h = f + e.width();
var k = d + e.height();
var l = b(d + j.top + c || 200, h + j.right, k + j.bottom, f + j.left);
    ...
    var h = !1;
    var i = 0;
    var j = {top: 0, right: 0, bottom: 0, left: 0};
    ...
    a(document).ready(function () {
        function b(b) {
            ...
            var d = b.css('font-size');
            var f = b.css('line-height');
        ...
        a(document).on('change', c, function () {
            ...
            var c = parseInt(a.attr('data-length'), 10);
            var d = a.val().length;
        ...
        a(document).on('change', g, function (b) {
            ...
            var e = a(this).width() - 15;
            var f = (a(this).parent('.range-field').outerWidth() - e || 0, a(this).val() * (e / d));
            c.hasClass('active') || c.velocity({height: '30px', width: '30px', top: '-30px', marginLeft: '5px'}, {duration: 300, easing: 'easeOutExpo'}), c.addClass('active').css('left', f);
        }), a(document).on('mousedown touchstart', g, function (b) {
            var c = a(this).siblings('.thumb');
            var d = a(this).attr('max');
            var e = a(this).width() - 15;
            var f = (a(this).parent('.range-field').outerWidth() - e || 0, a(this).val() * (e / d));
            c.length <= 0 && (c = a('<span class="thumb"><span class="value"></span></span>'), a(this).after(c)), c.find('.value').html(a(this).val()), h = !0, a(this).addClass('active'), c.hasClass('active') || c.velocity({height: '30px', width: '30px', top: '-30px', marginLeft: '5px'}, {duration: 300, easing: 'easeOutExpo'}), 'input' !== b.type && c.addClass('active').css('left', f);
        }), a(document).on('mouseup touchend', i, function () {
            h = !1, a(this).removeClass('active');
        }), a(document).on('input mousemove touchmove', i, function (b) {
            var c = a(this).children('.thumb');
            var d = a(this).find(g);
            var e = d.attr('max');
            var f = d.width() - 15;
            var i = (a(this).outerWidth() - f || 0, d.val() * (f / e));
            h && (c.hasClass('active') || c.velocity({height: '30px', width: '30px', top: '-30px', marginLeft: '5px'}, {duration: 300, easing: 'easeOutExpo'}), c.addClass('active').css('left', i), c.find('.value').html(c.siblings(g).val()));
        }), a(document).on('mouseout touchleave', i, function () {
            if (!h) {
                var b = a(this).children('.thumb');
                b.hasClass('active') && b.velocity({height: '0', width: '0', top: '10px', marginLeft: '15px'}, {
                    duration: 100
                }), b.removeClass('active');
            }

        }), a.fn.autocomplete = function (b) {
            var c = {data: {}, limit: 1 / 0, onAutocomplete: null, minLength: 1};
            return b = a.extend(c, b), this.each(function () {
                    var c;
                    var d = a(this);
                    var e = b.data;
                    var f = 0;
                    var g = -1;
                    var h = d.closest('.input-field');
                    if (!a.isEmptyObject(e)) {
                        var i;
                        var j = a('<ul class="autocomplete-content dropdown-content"></ul>');
                        ...
                        var k = function (a, b) {
                                var c = b.find('img');
                                var d = b.text().toLowerCase().indexOf('' + a.toLowerCase());
                                var e = d + a.length - 1;
                                var f = b.text().slice(0, d);
                                var g = b.text().slice(d, e + 1);
                                var h = b.text().slice(e + 1);
                        ...
                        d.off('blur.autocomplete').on('blur.autocomplete', function () {
                            ...
                            var b;
                            var c = a.which;
                            var d = j.children('li').length;
                            var e = j.children('.active').first();
        ...
        a(this).each(function () {
            ...
            if (!d.hasClass('browser-default')) {
                ...
                var j = d.children('option, optgroup');
                var k = [];
                var l = !1;
                var m = d.find('option:selected').html() || d.find('option:first').html() || '';
                var n = function (b, c, d) {
                        var f = c.is(':disabled') ? 'disabled ' : '';
                        var g = 'optgroup-option' === d ? 'optgroup-option ' : '';
                        var h = e ? '<input type="checkbox"' + f + '/><label></label>' : '';
                        var j = c.data('icon');
                        var k = c.attr('class');
                        if (j) {
                            var l = '';
                ...
                var p = m.replace(/"/g, '&quot;');
                var q = a('<input type="text" class="select-dropdown" readonly="true" ' + (d.is(':disabled') ? 'disabled' : '') + ' data-activates="select-options-' + g + '" value="' + p + '"/>');
                ...
                var t = function (b) {
                        ...
                        if (13 != b.which || i.is(':visible')) {
                            ...
                            if (c && d.indexOf(b.which) === -1) {
                                s.push(c);
                                var f = s.join('');
                                var g = i.find('li').filter(function () {
            ...
            return b = a.extend(c, b), this.each(function () {
                    ...
                    function d(a) {
                        a >= j.length ? a = 0 : a < 0 && (a = j.length - 1), k = i.find('.active').index(), k != a && (e = j.eq(k), $caption = e.find('.caption'), e.removeClass('active'), e.velocity({
                            ...
                            opacity: 1
                        }, {duration: b.transition, queue: !1, easing: 'easeOutQuad'}), j.eq(a).find('.caption').velocity({opacity: 1, translateX: 0, translateY: 0}, {duration: b.transition, delay: b.transition, queue: !1, easing: 'easeOutQuad'}), j.eq(a).addClass('active'), b.indicators && f.eq(a).addClass('active'));
                    }
                    var e;
                    var f;
                    var g;
                    var h = a(this);
                    var i = h.find('ul.slides').first();
                    var j = i.find('> li');
                    var k = i.find('.active').index();
                    k != -1 && (e = j.eq(k)), h.hasClass('fullscreen') || (b.indicators ? h.height(b.height + 40) : h.height(b.height), i.height(b.height)), j.find('.caption').each(function () {
                        ...
                        opacity: 1
                    }, {duration: b.transition, queue: !1, easing: 'easeOutQuad'}), k = 0, e = j.eq(k), b.indicators && f.eq(k).addClass('active')), e.find('img').each(function () {
                    ...
                    h.hammer({
                        ...
                        if ('touch' === a.gesture.pointerType) {
                            ...
                            var d = a.gesture.velocityX;
                            var e = a.gesture.velocityY;
                            $curr_slide = i.find('.active'), Math.abs(d) > Math.abs(e) && $curr_slide.velocity({
                                translateX: c
                            }, {duration: 50, queue: !1, easing: 'easeOutQuad'}), 4 === b && (c > h.innerWidth() / 2 || d < -.65) ? n = !0 : 2 === b && (c < -1 * h.innerWidth() / 2 || d > .65) && (m = !0);
                            var f;
                            m && (f = $curr_slide.next(), 0 === f.length && (f = j.first()), f.velocity({
                                opacity: 1
                            }, {duration: 300, queue: !1, easing: 'easeOutQuad'})), n && (f = $curr_slide.prev(), 0 === f.length && (f = j.last()), f.velocity({
                                opacity: 1
                        ...
                        'touch' === a.gesture.pointerType && ($curr_slide = i.find('.active'), l = !1, curr_index = i.find('.active').index(), !n && !m || j.length <= 1 ? $curr_slide.velocity({
                            translateX: 0
                        }, {duration: 300, queue: !1, easing: 'easeOutQuad'}) : m ? (d(curr_index + 1), $curr_slide.velocity({
    ...
    var b = {data: [], placeholder: '', secondaryPlaceholder: '', autocompleteOptions: {}};
    a(document).ready(function () {
        ...
        var d = this;
        if (this.$el = a(this), this.$document = a(document), this.SELS = {CHIPS: '.chips', CHIP: '.chip', INPUT: 'input', DELETE: '.material-icons', SELECTED_CHIP: '.selected'}, 'data' === c) {
        ...
        d.hasAutocomplete = !a.isEmptyObject(e.autocompleteOptions.data), this.init = function () {
            ...
            d.$document.off('click.chips-focus', b.CHIPS).on('click.chips-focus', b.CHIPS, function (c) {
                ...
                if (!a(c.target).is('input, textarea')) {
                    var e;
                    var f = d.$document.find(b.CHIP + b.SELECTED_CHIP);
                    var g = f.closest(b.CHIPS);
                    var h = f.siblings(b.CHIP).length;
                    if (f.length) {
                        if (8 === c.which || 46 === c.which) {
                            ...
                            if (e = f.index() + 1, a(b.CHIP).removeClass('selected'), e > h) {
                ...
                var e = a(c.target);
                var f = e.closest(b.CHIPS);
                var g = f.children(b.CHIP).length;
                if (13 === c.which) {
    ...
    var b = function (b) {
            ...
            if (c.hasClass('active') === !1) {
                var d;
                var e;
                var f = c.hasClass('horizontal');
                f === !0 ? e = 40 : d = 40, c.addClass('active'), c.find('ul .btn-floating').velocity({scaleY: '.4', scaleX: '.4', translateY: d + 'px', translateX: e + 'px'}, {
                    duration: 0
                });
                var g = 0;
    ...
    var c = function (a) {
            ...
            var c;
            var d = a;
            var e = d.hasClass('horizontal');
            e === !0 ? c = 40 : b = 40, d.removeClass('active');d.find('ul .btn-floating').velocity('stop', !0), d.find('ul .btn-floating').velocity({opacity: '0', scaleX: '.4', scaleY: '.4', translateY: b + 'px', translateX: c + 'px'}, {
                duration: 80
            });
        };
    var d = function (b) {
            if ('true' !== b.attr('data-open')) {
                ...
                var i = b[0].getBoundingClientRect();
                var j = b.find('> a').first();
                var k = b.find('> ul').first();
                var l = a('<div class="fab-backdrop"></div>');
                var m = j.css('background-color');
                j.append(l), c = i.left - g / 2 + i.width / 2, d = h - i.bottom, f = g / l.width(), b.attr('data-origin-bottom', i.bottom), b.attr('data-origin-left', i.left), b.attr('data-origin-width', i.width), b.addClass('active'), b.attr('data-open', !0), b.css({
                    ...
                    'transition': 'none'
                }), j.css({transform: 'translateY(' + -d + 'px)', transition: 'none'}), l.css({
                    'background-color': m
                }), setTimeout(function () {
                    b.css({transform: '', transition: 'transform .2s cubic-bezier(0.550, 0.085, 0.680, 0.530), background-color 0s linear .2s'}), j.css({overflow: 'visible', transform: '', transition: 'transform .2s'}), setTimeout(function () {
                        b.css({'overflow': 'hidden', 'background-color': m}), l.css({transform: 'scale(' + f + ')', transition: 'transform .2s cubic-bezier(0.550, 0.055, 0.675, 0.190)'}), k.find('> li > a').css({
                            opacity: 1
    ...
    var e = function (a) {
            if ('true' === a.attr('data-open')) {
                ...
                var g = a.attr('data-origin-width');
                var h = a.attr('data-origin-bottom');
                var i = a.attr('data-origin-left');
                var j = a.find('> .btn-floating').first();
                var k = a.find('> ul').first();
                var l = a.find('.fab-backdrop');
                var m = j.css('background-color');
                b = i - e / 2 + g / 2, c = f - h, d = e / l.width(), a.removeClass('active'), a.attr('data-open', !1), a.css({'background-color': 'transparent', 'transition': 'none'}), j.css({
                    transition: 'none'
                }), l.css({'transform': 'scale(0)', 'background-color': m}), k.find('> li > a').css({
                    opacity: ''
                }), setTimeout(function () {
                    l.remove(), a.css({
                        'text-align': '',
                    ...
                    }), j.css({overflow: '', transform: 'translate3d(0,' + c + 'px,0)'}), setTimeout(function () {
    ...
    Materialize.fadeInImage = function (b) {
        ...
        c.css({
            ...
            opacity: 1
        }, {duration: 650, queue: !1, easing: 'easeOutSine'}), a(c).velocity({
            opacity: 1
        }, {duration: 1300, queue: !1, easing: 'swing', step: function (b, c) {
                c.start = 100;
                var d = b / 100;
                var e = 150 - (100 - b) / 1.75;
        ...
        a('.dismissable').each(function () {
            a(this).hammer({
                ...
                if ('touch' === d.gesture.pointerType) {
                    ...
                    var g = d.gesture.deltaX;
                    var h = d.gesture.velocityX;
                    e.velocity({
                        translateX: g
                    }, {duration: 50, queue: !1, easing: 'easeOutQuad'}), 4 === f && (g > e.innerWidth() / 2 || h < -.75) && (b = !0), 2 === f && (g < -1 * e.innerWidth() / 2 || h > .75) && (c = !0);
                }
                    ...
                    if (b || c) {
                        ...
                        f = b ? e.innerWidth() : -1 * e.innerWidth(), e.velocity({
                            translateX: f
                                ...
                                e.css('border', 'none'), e.velocity({height: 0, padding: 0}, {duration: 200, queue: !1, easing: 'easeOutQuad', complete: function () {
                                        e.remove();
                                }});
                        }});
                    }
    ...
    function b(f, g, i, l) {
        ...
        function o() {
            y.$root.on({'keydown': q, 'focusin': function (a) {
                ...
                var b = a(this);
                var c = b.data();
                var d = b.hasClass(v.navDisabled) || b.hasClass(v.disabled);
                var e = h();
        ...
        var u = i ? a.extend(!0, {}, i.defaults, l) : l || {};
        var v = a.extend({}, b.klasses(), u.klass);
        var w = a(f);
        var x = function () {
                return this.start();
            };
...
var e = d[0].offsetWidth;
    ...
    var i = a(window);
    var j = a(document);
    var k = a(document.documentElement);
    ...
    function c(a, b) {
        ...
        var d = a.$node[0];
        var e = d.value;
        var f = a.$node.data('value');
        var g = f || e;
        var h = f ? b.formatSubmit : b.format;
        var i = function () {
        ...
        c.settings = b, c.$node = a.$node, c.queue = {
            ...
            format: h
        }) : c.set('select', null).set('highlight', c.item.now), c.key = {40: 7, 38: -7, 39: function () {
                return i() ? -1 : 1;
            }, 37: function () {
                return i() ? 1 : -1;
            }, go: function (a) {
                var b = c.item.highlight;
                var d = new Date(b.year, b.month, b.date + a);
                c.set('highlight', d, {
                    interval: a
                }), this.render();
    ...
    c.prototype.set = function (a, b, c) {
        ...
        var h;
        var i = b.isArray(c);
        var j = b.isPlainObject(c);
        var k = this.item.view;
        if (i || j) {
        ...
        var j = this;
        var k = c;
        var l = d && d.interval ? d.interval : 1;
        var m = j.item.enable === -1;
        var n = j.item.min;
        var o = j.item.max;
        var p = m && j.item.disable.filter(function (a) {
                if (b.isArray(a)) {
        ...
        if ((!d || !d.nav) && (!m && j.disabled(c) || m && j.disabled(c) && (p || e || g) || !m && (c.pick <= n.pick || c.pick >= o.pick))) {
            for (m && !p && (!g && l > 0 || !e && l < 0) && (l *= -1); j.disabled(c) && (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k, l = l > 0 ? 1 : -1), c.pick <= n.pick ? (h = !0, l = 1, c = j.create([n.year, n.month, n.date + (c.pick === n.pick ? 0 : -1)])) : c.pick >= o.pick && (i = !0, l = -1, c = j.create([o.year, o.month, o.date + (c.pick === o.pick ? 0 : 1)])), !h || !i);) {
        ...
        var c = this;
        var d = c.item.disable.filter(function (d) {
        ...
        return b && 'string' == typeof b ? (c && c.format || (c = c || {}, c.format = d.settings.format), d.formats.toArray(c.format).map(function (a) {
            var c = d.formats[a];
            var g = c ? f.trigger(c, d, [b, e]) : a.replace(/^!/, '').length;
        ...
        var r = function (d) {
                var e = k.year;
                var g = c.selectYears === !0 ? 5 : ~~(c.selectYears / 2);
                if (g) {
                    var h = m.year;
                    var i = n.year;
                    var j = e - g;
                    ...
                    if (c.selectYears && void 0 == d) {
                        return f.node('select', f.group({min: j, max: l, i: 1, node: 'option', item: function (a) {
        ...
        return createDayLabel = function () {
                ...
                return b;
            }, f.node('div', f.node('div', createWeekdayLabel(), 'picker__weekday-display') + f.node('div', q('short_months'), c.klass.month_display) + f.node('div', createDayLabel(), c.klass.day_display) + f.node('div', r('raw'), c.klass.year_display), c.klass.date_display) + f.node('div', f.node('div', (c.selectYears ? q() + r() : q() + r()) + p() + p(1), c.klass.header) + f.node('table', o + f.node('tbody', f.group({min: 0, max: e - 1, i: 1, node: 'tr', item: function (a) {
                            ...
                            return [f.group({min: d * a - k.day + e + 1, max: function () {
                                    ...
                                    var e = j && j.pick == a.pick;
                                    var g = l && b.disabled(a) || a.pick < m.pick || a.pick > n.pick;
                                    var o = f.trigger(b.formats.toString, b, [c.format, a]);
                                    return [f.node('div', a.date, function (b) {
                                        return b.push(k.month == a.month ? c.klass.infocus : c.klass.outfocus), h.pick == a.pick && b.push(c.klass.now), d && b.push(c.klass.selected), e && b.push(c.klass.highlighted), g && b.push(c.klass.disabled), b.join(' ');
                                    }([c.klass.day]), 'data-pick=' + a.pick + ' ' + f.ariaAttr({role: 'gridcell', label: o, selected: !(!d || b.$node.val() !== o) || null, activedescendant: !!e || null, disabled: !!g || null})), '', f.ariaAttr({
                                        role: 'presentation'
                                    })];
                            }})];
                    }})), c.klass.table, 'id="' + b.$node[0].id + '_table" ' + f.ariaAttr({role: 'grid', controls: b.$node[0].id, readonly: !0})), c.klass.calendar_container) + f.node('div', f.node('button', c.today, 'btn-flat picker__today', 'type=button data-pick=' + h.pick + (a && !b.disabled(h) ? '' : ' disabled') + ' ' + f.ariaAttr({
    ...
    a.fn.characterCounter = function () {
        return this.each(function () {
            var e = a(this);
            var f = e.parent().find('span[class="character-counter"]');
            if (!f.length) {
    ...
    var b = {init: function (b) {
            ...
            return this.each(function (c) {
                function e() {
                    'undefined' != typeof window.ontouchstart && (M[0].addEventListener('touchstart', n), M[0].addEventListener('touchmove', o), M[0].addEventListener('touchend', p)), M[0].addEventListener('mousedown', n), M[0].addEventListener('mousemove', o), M[0].addEventListener('mouseup', p), M[0].addEventListener('mouseleave', p), M[0].addEventListener('click', l);
                }
                function f(a) {
                ...
                function i(c) {
                    ...
                    var k;
                    var l = u;
                    if (t = 'number' == typeof c ? c : t, u = Math.floor((t + w / 2) / w), f = t - u * w, g = f < 0 ? 1 : -1, i = -g * f * 2 / w, e = x >> 1, b.fullWidth ? k = 'translateX(0)' : (k = 'translateX(' + (M[0].clientWidth - r) / 2 + 'px) ', k += 'translateY(' + (M[0].clientHeight - s) / 2 + 'px)'), N) {
                        var m = u % x;
                        var n = L.find('.indicator-item.active');
                    ...
                    for ((!b.noWrap || u >= 0 && u < x) && (j = q[h(u)], a(j).hasClass('active') || (M.find('.carousel-item').removeClass('active'), a(j).addClass('active')), j.style[E] = k + ' translateX(' + -f / 2 + 'px) translateX(' + g * b.shift * i * d + 'px) translateZ(' + b.dist * i + 'px)', j.style.zIndex = 0, b.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * i, j.style.opacity = tweenedOpacity, j.style.display = 'block'), d = 1; d <= e; ++d) {
                        b.fullWidth ? (zTranslation = b.dist, tweenedOpacity = d === e && f < 0 ? 1 - i : 1) : (zTranslation = b.dist * (2 * d + i * g), tweenedOpacity = 1 - .2 * (2 * d + i * g)), (!b.noWrap || u + d < x) && (j = q[h(u + d)], j.style[E] = k + ' translateX(' + (b.shift + (w * d - f) / 2) + 'px) translateZ(' + zTranslation + 'px)', j.style.zIndex = -d, j.style.opacity = tweenedOpacity, j.style.display = 'block'), b.fullWidth ? (zTranslation = b.dist, tweenedOpacity = d === e && f > 0 ? 1 - i : 1) : (zTranslation = b.dist * (2 * d - i * g), tweenedOpacity = 1 - .2 * (2 * d - i * g)), (!b.noWrap || u - d >= 0) && (j = q[h(u - d)], j.style[E] = k + ' translateX(' + (-b.shift + (-w * d - f) / 2) + 'px) translateZ(' + zTranslation + 'px)', j.style.zIndex = -d, j.style.opacity = tweenedOpacity, j.style.display = 'block');

                    }
                    if ((!b.noWrap || u >= 0 && u < x) && (j = q[h(u)], j.style[E] = k + ' translateX(' + -f / 2 + 'px) translateX(' + g * b.shift * i + 'px) translateZ(' + b.dist * i + 'px)', j.style.zIndex = 0, b.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * i, j.style.opacity = tweenedOpacity, j.style.display = 'block'), l !== u && 'function' == typeof b.onCycleTo) {
                        var o = M.find('.carousel-item').eq(h(u));
                ...
                function j() {
                    ...
                    var c;
                    var d;
                    a = Date.now(), b = a - G, G = a, c = t - F, F = t, d = 1e3 * c / (1 + b), D = .8 * d + .2 * D;
                }
                function k() {
                    var a;
                    var c;
                    B && (a = Date.now() - G, c = B * Math.exp(-a / b.duration), c > 2 || c < -2 ? (i(C - c), requestAnimationFrame(k)) : i(C));
                }
                function l(c) {
                    if (I) {
                ...
                function m(a) {
                    var c = u % x - a;
                    b.noWrap || (c < 0 ? Math.abs(c + x) < Math.abs(c) && (c += x) : c > 0 && Math.abs(c - x) < c && (c -= x)), c < 0 ? M.trigger('carouselNext', [Math.abs(c)]) : c > 0 && M.trigger('carouselPrev', [c]);
                }
                function n(a) {
                    a.preventDefault(), v = !0, I = !1, J = !1, z = f(a), A = g(a), D = B = 0, F = t, G = Date.now(), clearInterval(H), H = setInterval(j, 100);
                }
                function o(a) {
                    var b;
                    var c;
                    var d;
                    if (v) {
                        if (b = f(a), y = g(a), c = z - b, d = Math.abs(A - y), d < 30 && !J) {
                            (c > 2 || c < -2) && (I = !0, z = b, i(t + c));
                        }
                        else {
                            if (I) {
                ...
                function p(a) {
                    if (v) {
                        return v = !1, clearInterval(H), C = t, (D > 10 || D < -10) && (B = .9 * D, C = t + B), C = Math.round(C / w) * w, b.noWrap && (C >= w * (x - 1) ? C = w * (x - 1) : C < 0 && (C = 0)), B = C - t, G = Date.now(), requestAnimationFrame(k), I && (a.preventDefault(), a.stopPropagation()), !1;
                    }
                }
                var q;
                var r;
                ...
                var J;
                var K = d + c;
                var L = a('<ul class="indicators"></ul>');
                var M = a(this);
                var N = M.attr('data-indicators') || b.indicators;
                if (M.hasClass('initialized')) {
                    return a(this).trigger('carouselNext', [1e-6]), !0;
                }

                if (b.fullWidth) {
                    b.dist = 0;
                    var O = M.find('.carousel-item img').first();
                    O.length ? imageHeight = O.on('load', function () {
                        M.css('height', a(this).height());
                    }) : (imageHeight = M.find('.carousel-item').first().height(), M.css('height', imageHeight)), N && M.find('.carousel-fixed-item').addClass('with-indicators');
                }

                M.addClass('initialized'), v = !1, t = C = 0, q = [], r = M.find('.carousel-item').first().innerWidth(), s = M.find('.carousel-item').first().innerHeight(), w = 2 * r + b.padding, M.find('.carousel-item').each(function (b) {
                    if (q.push(a(this)[0]), N) {
                ...
                }), N && M.append(L), x = q.length, E = 'transform', ['webkit', 'Moz', 'O', 'ms'].every(function (a) {
                    var b = a + 'Transform';
                    return 'undefined' == typeof document.body.style[b] || (E = b, !1);
                }), a(window).off('resize.' + K).on('resize.' + K, function () {
                    b.fullWidth ? (r = M.find('.carousel-item').first().innerWidth(), s = M.find('.carousel-item').first().innerHeight(), w = 2 * r + b.padding, t = 2 * u * r, C = t) : i();
                }), e(), i(t), a(this).on('carouselNext', function (a, b) {
                    void 0 === b && (b = 1), C = w * Math.round(t / w) + w * b, t !== C && (B = C - t, G = Date.now(), requestAnimationFrame(k));
    ...
    var b = {init: function (b) {
            return this.each(function () {
                ...
                var d = (a('body'), a(this));
                var e = d.parent('.tap-target-wrapper');
                var f = e.find('.tap-target-wave');
                var g = e.find('.tap-target-origin');
                var h = d.find('.tap-target-content');
                ...
                var j = function () {
                        e.is('.open') && (e.removeClass('open'), g.off('click.tapTarget'), a(document).off('click.tapTarget'));
                    };
                var k = function () {
                        ...
                        var j = c.outerWidth();
                        var k = c.outerHeight();
                        var l = b ? c.offset().top - a(document).scrollTop() : c.offset().top;
                        var m = b ? c.offset().left - a(document).scrollLeft() : c.offset().left;
                        ...
                        N.top = t ? y : '', N.right = s ? n - z - w : '', N.bottom = u ? o - y - x : '', N.left = r ? z : '', N.position = A, e.css(N), h.css({
                            ...
                            padding: H,
                            verticalAlign: I
                        }), f.css({top: L, left: M, width: J, height: K});
                    };
